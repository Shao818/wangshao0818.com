...
<font face="仿宋"  size=3>　　计算机门外汉，却痴迷于编程中的奥秘。博客之路从`CSDN`到`简书`再到`cnblogs`再到`Hexo`,目前止于`Hugo`。历程可谓：由简至繁再至简，止于对`R语言`的“粘性”和实质重于形式。</font>　  
...
<div align=center> 
<font face="华文行楷"  size=8>欢迎关注公众号</font>
</div>
